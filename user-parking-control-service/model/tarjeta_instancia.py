class TarjetaInstancia:
    ...
    def __init__(self, tarjeta_instancia_id, mes, dia_semana, dia_fecha, hora, minutos, patente, usuario_id, tarjeta_id):
    ...
    def __init__(self, mes, dia_semana, dia_fecha, hora, minutos, patente, usuario_id, tarjeta_id):
        self.__mes = mes
        self.__dia_semana = dia_semana
        self.__dia_fecha = dia_fecha
        self.__hora = hora
    ...
    def get_tarjeta(self, tarjeta_instancia_id, mes, dia_semana, dia_fecha, hora, minutos, patente, usuario_id, tarjeta_id):
