...
export default function TarjetaPendienteDePago2() {
                ...
                <tr key={tarjeta_instancia.patente}>
                  ...
                  <td>
                    <button
                      ...
                      onClick={(e) =>
                        deleteFinishedCardListById(
                          tarjeta_instancia.patente,
                          tarjeta_instancia.usuario_id
                        )
                      }
                    >
                      Limpiar tarjeta/s
